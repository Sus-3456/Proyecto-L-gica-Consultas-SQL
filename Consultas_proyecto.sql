...
select 
    stddev(film.replacement_cost) as "dsv_stdr",
    variance(film.replacement_cost) as "varianza"
from film;
...
select 
    film.rating as "clasif", 
    avg(film.length) as "avg_duracion"
from film
